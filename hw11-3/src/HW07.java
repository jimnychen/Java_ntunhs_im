...
public class HW07 {
    public static void main(String[] args) {
        ...
        int computer =0;
        while (!validInput) {
            System.out.println("computer player?(0:no/1:yes)");
            try {
            ...
            if(computer !=0&&computer !=1){
                ...
                System.out.println("please Enter munbers only");
                scanner.nextLine();
            }
        ...
        while (!gameEnded) {
            ...
            if (game.hasWinner()) {
                ...
                if(computer == 1){
                    int upper = 2;
                    int row = rand.nextInt(upper);
                    int col = rand.nextInt(upper);

                    while (!game.makeMove(row,col)){
                        row = rand.nextInt(upper);
                        col = rand.nextInt(upper);
                    }
                    game.switchPlayer();
                }
            }
